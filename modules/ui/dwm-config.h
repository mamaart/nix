...
static const char *fonts[]          = { "Lilex Nerd Font:size=13" };
static const char dmenufont[]       = "Lilex Nerd Font::size=13";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { "#50fa7b", "#282a36", "#6272a4" },
	[SchemeSel]  = { "#bd93f9", "#44475a", "#ff79c6"},
};
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_g,      spawn,          SHCMD("surf chat.openai.com/chat") },
	{ MODKEY|ShiftMask,             XK_e,      spawn,          SHCMD("~/.config/dwm/scripts/emojicmd.sh") },
